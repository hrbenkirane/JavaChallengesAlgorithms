package com.codewithtwins.codility.challenges.fibonacci;

import java.util.ArrayList;
import java.util.List;

public class C36FibFrog {
    ...
    public static void main(String[] args) {
        System.out.println(new C36FibFrog().solution(new int[] {0,0,0,1,1,0,1,0,0,0,0}));
    }
}
